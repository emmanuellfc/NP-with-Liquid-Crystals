...
ramp_file = "T_CM&NP_" + str(temp0) + "_P_" + str(pressure) + "_ramp.gsd"
...
npt = hoomd.md.integrate.npt(group = groupNP_mes, kT = temp, tau = 17.0, tauP = 17.0, P = pressure);
