...
# ## Temperature: 7.0 -> 7.2 | Cluster Run
...
ramp_file = "T_CM&NP_" + str(t_0) + "_P_3.5_ramp.gsd"
...
npt = hoomd.md.integrate.npt(group = groupNP_mes, kT = temp, tau = 0.3, tauP = 0.5, P = p_max);
